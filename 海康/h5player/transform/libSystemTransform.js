...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 313968,
    DYNAMIC_BASE = 5556848,
    DYNAMICTOP_PTR = 313792;
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=313808;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 313856, 4), 313856);
...
/** @type {function(...*):?} */
var _SysTransModifyMediaField = Module["_SysTransModifyMediaField"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["SysTransModifyMediaField"].apply(null, arguments)
};
